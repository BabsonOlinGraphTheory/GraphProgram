...
This module contains useful matrix and vector manipulations
that are completely independent of the structure of the graph models.
Any strictly math functions should go in here so as to be available to 
multiple classes.
"""
from math import *
